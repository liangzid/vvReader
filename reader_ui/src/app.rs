...
use text_selection_widget::{open_one_reader, render_selected_text};
	...
	let rt=tokio::runtime::Builder::new_current_thread()
        ...
        egui::SidePanel::left("options")
            ...
            .show(ctx, |ui| {
                ...
                (*default_color, *strong_color) = if ui.visuals().dark_mode {
                ...
                ui.horizontal(|ui| {
                    ...
                    track_lang |= ui.radio_value(lang, "en".to_owned(), "English").clicked();
                });
                ...
                ui.horizontal(|ui| {
                    ...
                    if (*login_state).eq(&0) {
                        ...
                        match lang.as_str() {
                            "zh" => ui.label(format!("账户 {} 登录.", email)),
                ...
                ui.horizontal(|ui| match lang.as_str() {
                    "zh" => {
                            ...
                            *is_open_activate_help = true;
                            ...
                            if let Some(pth) = rfd::FileDialog::new().pick_file() {
                                ...
                                let tmp: (
                                    HashMap<
                                        String,
                                        (bool, DocLabeled, bool, (u8, u8, u8), f32, bool),
                                    >,
                                    Vec<(bool, String, EasyMarkEditor)>,
			...
			::new().pick_file() {
			    let stxts=ExtractHeadline(&uploadpath);
                        ...
                        if !uploadpath.clone().ends_with(".txt") {
                            ...
                            ui.colored_label(egui::Color32::RED, tt_file_us);
                        }
			    ...
			    RawStructruedText::transfer2tree(&stxts.heads),
                        ...
                        let fnme = newpth.to_str().unwrap();
                        reading_records.insert(
                            String::from(fnme),
                            (true, doc, false, (255, 0, 0), 12.0, false),
                        );
                    }
                }
                ...
                if ui.button(ttmd).clicked() {
                    md_states.push((true, "Undefined".to_owned(), EasyMarkEditor::default()));
                }
